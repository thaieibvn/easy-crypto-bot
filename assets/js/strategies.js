...
function addNewSmaRule(id, type) {
  $('#' + type + 'Rules>ul').append('<li class="' + type + '-sma" id="' + id + '">' + '<span class="bold">Rule: </span>On '+
  '<div id="' + id + 'TF" class="inline" style=""><div class="drop-down"><a href="#/" onclick="dropDown(\'#' + id + 'TF\')"><span class="name timeframe">1 day</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'1 minute\', \'#' + id + 'TF\')">1 minute</a></li><li><a href="#/" onclick="dropDownItem(\'3 minutes\', \'#' + id + 'TF\')">3 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'5 minutes\', \'#' + id + 'TF\')">5 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'15 minutes\',\'#' + id + 'TF\')">15 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'30 minutes\', \'#' + id + 'TF\')">30 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'1 hour\', \'#' + id + 'TF\')">1 hour</a></li><li><a href="#/" onclick="dropDownItem(\'2 hours\', \'#' + id + 'TF\')">2 hours</a></li><li><a href="#/" onclick="dropDownItem(\'4 hours\', \'#' + id + 'TF\')">4 hours</a></li><li><a href="#/" onclick="dropDownItem(\'6 hours\', \'#' + id + 'TF\')">6 hours</a></li><li><a href="#/" onclick="dropDownItem(\'12 hours\', \'#' + id + 'TF\')">12 hours</a></li><li><a href="#/" onclick="dropDownItem(\'1 day\', \'#' + id + 'TF\')">1 day</a></li></ul></div></div>'
  +' timeframe the price is ' + '<div class="drop-down">' + '<a href="#/" onclick="dropDown(\'#' + id + '\')"><span class="name direction">above</span> <span ' + 'class="caret"></span></a>' + '<ul>' + '<li><a href="#/" onclick="dropDownItem(\'above\', \'#' + id + '\', function(){ $(\'#' + id + 'P\').show();$(\'#' + id + 'C\').hide()})">above</a></li>' + '<li><a href="#/" onclick="dropDownItem(\'bellow\', \'#' + id + '\', function(){ $(\'#' + id + 'P\').show();$(\'#' + id + 'C\').hide()})">bellow</a></li>' + '<li><a href="#/" onclick="dropDownItem(\'crossing\', \'#' + id + '\', function(){ $(\'#' + id + 'C\').show();$(\'#' + id + 'P\').hide()})">crossing</a></li>' + '</ul>' + '</div>' + '&nbsp;SMA with period <input class="period" type="number" value="20" /> ' + '<div id="' + id + 'P" class="inline"> by <input class="value" type="number" value="10" /> %</div>' + '<div id="' + id + 'C" class="inline" style="display:none;"> from ' + '<div class="drop-down">' + '<a href="#/" onclick="dropDown(\'#' + id + 'C\')"><span class="name cross-direction">bottom to top</span> <span ' + 'class="caret"></span></a>' + '<ul>' + '<li><a href="#/" onclick="dropDownItem(\'bottom to top\', \'#' + id + 'C\')">bottom to top</a></li>' + '<li><a href="#/" onclick="dropDownItem(\'top to bottom\', \'#' + id + 'C\')">top to bottom</a></li>' + '</ul>' + '</div>' + '</div>' + '&nbsp;<a title="Info" onclick="smaInfo()" href="#/"><i class="text-blue fa fa-info-circle"></i></a>' + '&nbsp;<a title="Remove Rule" onclick="removeRule(\'#' + id + '\')" href="#/"><i class="text-red fas fa-times"></i></a>' + '</li>');
}

function addNewEmaRule(id, type) {
  $('#' + type + 'Rules>ul').append('<li class="' + type + '-ema" id="' + id + '">' + '<span class="bold">Rule: </span>On '+
  '<div id="' + id + 'TF" class="inline" style=""><div class="drop-down"><a href="#/" onclick="dropDown(\'#' + id + 'TF\')"><span class="name timeframe">1 day</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'1 minute\', \'#' + id + 'TF\')">1 minute</a></li><li><a href="#/" onclick="dropDownItem(\'3 minutes\', \'#' + id + 'TF\')">3 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'5 minutes\', \'#' + id + 'TF\')">5 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'15 minutes\',\'#' + id + 'TF\')">15 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'30 minutes\', \'#' + id + 'TF\')">30 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'1 hour\', \'#' + id + 'TF\')">1 hour</a></li><li><a href="#/" onclick="dropDownItem(\'2 hours\', \'#' + id + 'TF\')">2 hours</a></li><li><a href="#/" onclick="dropDownItem(\'4 hours\', \'#' + id + 'TF\')">4 hours</a></li><li><a href="#/" onclick="dropDownItem(\'6 hours\', \'#' + id + 'TF\')">6 hours</a></li><li><a href="#/" onclick="dropDownItem(\'12 hours\', \'#' + id + 'TF\')">12 hours</a></li><li><a href="#/" onclick="dropDownItem(\'1 day\', \'#' + id + 'TF\')">1 day</a></li></ul></div></div>'
...
function addNewCmaRule(id, type) {
  $('#' + type + 'Rules>ul').append('<li class="' + type + '-cma" id="' + id + '">' + '<span class="bold">Rule: </span>On '+
  '<div id="' + id + 'TF" class="inline" style=""><div class="drop-down"><a href="#/" onclick="dropDown(\'#' + id + 'TF\')"><span class="name timeframe">1 day</span> <span class="caret"></span></a><ul><li><a href="#/" onclick="dropDownItem(\'1 minute\', \'#' + id + 'TF\')">1 minute</a></li><li><a href="#/" onclick="dropDownItem(\'3 minutes\', \'#' + id + 'TF\')">3 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'5 minutes\', \'#' + id + 'TF\')">5 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'15 minutes\',\'#' + id + 'TF\')">15 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'30 minutes\', \'#' + id + 'TF\')">30 minutes</a></li><li><a href="#/" onclick="dropDownItem(\'1 hour\', \'#' + id + 'TF\')">1 hour</a></li><li><a href="#/" onclick="dropDownItem(\'2 hours\', \'#' + id + 'TF\')">2 hours</a></li><li><a href="#/" onclick="dropDownItem(\'4 hours\', \'#' + id + 'TF\')">4 hours</a></li><li><a href="#/" onclick="dropDownItem(\'6 hours\', \'#' + id + 'TF\')">6 hours</a></li><li><a href="#/" onclick="dropDownItem(\'12 hours\', \'#' + id + 'TF\')">12 hours</a></li><li><a href="#/" onclick="dropDownItem(\'1 day\', \'#' + id + 'TF\')">1 day</a></li></ul></div></div>'
...
function openStrategy(strategy) {
  try {
    ...
    strategy.buyRules.forEach(rule => {
      ...
      let id = '#' + newBuyRule();
      $(id).find('.timeframe').text(rule.timeframe);
